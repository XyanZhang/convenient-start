...
const { log, makeInput, makeList, getLatestVersion, request, printErrorLog } = require('../utils')
const os = require('os'); 
...
async function getTemplateFromAPI() {
  try {
    const data = await request({
      url: 'https://www.huajin.com/agreement/f199dc01186e448d8d311b02da443d23.html',
      method: 'get',
    });
...
module.exports = async function createTemplate(name, opts) {
